...
-(void) provideContent:(SKPaymentTransaction *)transaction{
    UnitySendMessage("GameVar", "OnPayResultReturn", [[self transactionInfo:transaction] UTF8String]);
}
...
-(void) failedTransaction:(SKPaymentTransaction *)transaction{
    ...
    UnitySendMessage("GameVar", "OnPayResultReturnFail", [[self transactionInfo:transaction] UTF8String]);
