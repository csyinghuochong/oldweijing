...
public class AIPet : MonoBehaviour {
    ...
    public int PetType;                             //宠物类型          0：宠物（默认,始终跟随主角）    1：其他技能召唤（默认,在其他位置）
    ...
    private float ai_chaseRange;                    //AI追击范围
	...
	void Start () {
        ...
        Debug.Log("AAAAAA11111111111111111111111111");
        StartMovePosition();
	...
	void Update () {
        ...
        {
            //updateStarMoveNum = updateStarMoveNum + 1;
            //Debug.Log("updateStarMoveNum = " + updateStarMoveNum);
            //if (updateStarMoveNum > 0)
            //{
        ...
        {
            //设置宠物属性
            this.GetComponent<AI_Property>().AI_Act = (int)(Game_PublicClassVar.Get_game_PositionVar.Obj_Rose.GetComponent<Rose_Proprety>().Rose_ActMax * 0.2f);
            ifUpdatePetPro = true;
        }
        ...
        if (AI_Target == null)
        {
            ...
            {
                AI_Target = Game_PublicClassVar.Get_game_PositionVar.Obj_Rose.GetComponent<Rose_Status>().Obj_ActTarget;
        ...
        */
            ...
            case "0":
                ...
                */
                ...
                if (roseDistance >= 2.0f)
                {
                    ...
                    //petMoveStatus = true;
                    //开始跟随移动
                    //ai_NavMesh.speed = AI_MoveSpeed*2;positionNum
                    ai_NavMesh.speed = 4;
                    Vector3 petMovePosition = new Vector3(petMove_X, obj_Rose.transform.position.y, petMove_Z);
                    switch (PetType) { 
                        //主角,跟随主角移动
                        case 0:
                            petMovePosition = obj_Rose.transform.position;
                        break;
                        //技能召唤,跟随主角身后的点移动
                        case 1:
                            if (PositionObj != null) {
                    ...
                    //Debug.Log(this.gameObject.name +  "   petMovePosition = " + petMovePosition);
                    ...
                    //petMovePosition.y = hit.position.y;
                    //ai_NavMesh.SetDestination(walkPosition);
        ...
        if (AI_Distance < 20)
        {
            ...
            if (!AI_Hp_Status)
            {
                ...
                //获取当前角色的名字
                string roseNameStr = Game_PublicClassVar.Get_game_PositionVar.Obj_Rose.GetComponent<Rose_Proprety>().Rose_Name;
                ...
                UIname.text = roseNameStr + "的宠物";
                //UI_Hp.GetComponent<UI_AIHp>().Obj_aiRoseName.GetComponent<Text>().text = "(" + roseNameStr + "的宠物)";
                UI_Hp.GetComponent<UI_AIHp>().Obj_aiRoseName.GetComponent<Text>().text = "";
	...
	public void AIAct(){
        if (AI_Target != null) {
            Game_PublicClassVar.Get_game_PositionVar.Obj_Rose.GetComponent<Rose_Status>().RoseIfHit = true;             //播放受击特效
            Game_PublicClassVar.Get_fight_Formult.PetActMonster(this.gameObject, "60020001", AI_Target, false);         //战斗
