...
public class UI_BagSpace: MonoBehaviour
{
    ...
    public string SpaceType;                    //格子类型（移动道具位置的时候用的，1：背包 2：仓库 3：英雄栏）
    ...
    void updateItem() {
        ...
        if (ItemID != "0")
        {
            ...
            ItemNum = Game_PublicClassVar.Get_function_DataSet.DataSet_ReadData("ItemNum", "ID", BagPosition, "RoseBag");
            //获取道具的Icon和品质信息
