...
public class Rose_TaskList : MonoBehaviour {
    ...
    private float loadTaskType(string taskType,List<string> taskID,float hight) {
        ...
        switch(taskType){
            ...
            case "1":
                ...
                if (ifShow_Main == "1")
                {
                    hight = -task_Main.Count * 30.0f - 40.0f;
                }
                else {
            ...
            case "2":
                ...
                if (ifShow_Branch == "1")
                {
                    hight = hight - task_Branch.Count * 30.0f - 40.0f;
                }
                else
                {
                    hight = hight - 40.0f;
    ...
    private void loadTaskData(string taskType, List<string> taskID)
    {
        ...
        foreach(string nowTaskID in taskID){
            ...
            UI_RoseTaskListName.transform.localPosition = new Vector3(400, TaskNum * -30.0f, 0);
