...
public class UI_ShiLianZhiTaObj : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        */
        ...
        //获取当前BOSS连斩次数
        KillBossNum = PlayerPrefs.GetInt("FuBenKillBossNum");
    ...
    public void SendEexp() {
        ...
        if (KillBossNum < 1) {
            Game_PublicClassVar.Get_function_UI.GameHint("今天未击败BOSS不能领取！");
            return;
        }
