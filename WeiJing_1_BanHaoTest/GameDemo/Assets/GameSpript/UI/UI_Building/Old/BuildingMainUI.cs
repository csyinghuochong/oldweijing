...
public class BuildingMainUI : MonoBehaviour {
    ...
    //public float returnTimeSum;     //点击关闭时建筑的返回时间,防止二次点击
	...
	void Update () {
        ...
        {
            Game_PublicClassVar.Get_function_UI.GameGirdHint("系统监测你修改了数据,不思悔改将立即删除账号信息！");
        }
    ...
    public void Btn_ClickBuilding() {
        Debug.Log("点击市政厅按钮点击市政厅按钮点击市政厅按钮点击市政厅按钮");
