        ...
        switch (eventType)
        {
            ...
            case"1":
                ...
                if (roseGold >= int.Parse(currencyNum)) { 
                    ...
                    Game_PublicClassVar.Get_function_Rose.SendRewardToBag(ItemID,ItemNum);
                    hintBtn();
            ...
            case "2":
                ...
                if (bagNum >= ItemNum) {
                    ...
                    Game_PublicClassVar.Get_function_Rose.SendReward(currencyType, currencyNum);
                    hintBtn();
                    Destroy(this.gameObject);
                }
            break;
            ...
            if (ifPayStatus)
            {
                //扣除金币奖励道具
                Game_PublicClassVar.Get_function_Rose.CostReward(currencyType, currencyNum);
                Game_PublicClassVar.Get_function_Rose.SendRewardToBag(ItemID, ItemNum,"0",0.5f);
